...
```
cd existing_repo
git remote add origin https://gitlab.engr.illinois.edu/hongboz2/yolovx.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.engr.illinois.edu/hongboz2/yolovx/-/settings/integrations)
